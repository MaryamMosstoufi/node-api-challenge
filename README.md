...
-   [ ] Describe a Resource?
        A resource can be anything that is saved in database or server. 
-   [ ] What can the API return to help clients know if a request was successful?
        It can return a HTTP status code. Status codes for success are in the range of 200-299 and for a request success we show 200. 
-   [ ] How can we partition our application into sub-applications?
        We can use Express Routers and partition our application APIs. 
